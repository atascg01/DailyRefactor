    ...
    <footer className="border-t border-[var(--border)] bg-[var(--muted)]/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold mb-3 text-[var(--foreground)]">Links</h4>
          ...
          {/* Tech */}
          <div>
            <h4 className="text-sm font-semibold mb-3 text-[var(--foreground)]">Tech</h4>
        ...
        <div className="mt-10 pt-6 border-t border-[var(--border)] text-center text-xs text-[var(--muted-foreground)]">
          &copy; {new Date().getFullYear()} DailyRefactor. All rights reserved.
        </div>
      </div>
    </footer>
  );
