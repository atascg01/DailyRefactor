...
- [1. What are Git Aliases?](#1-what-are-git-aliases)
- [2. Setting Up Aliases](#2-setting-up-aliases)
  - [2.1 Temporary Aliases](#21-temporary-aliases)
  - [2.2 Permanent Aliases](#22-permanent-aliases)
- [3. Useful Git Aliases](#3-useful-git-aliases)
  - [3.1 Status Aliases](#31-status-aliases)
  - [3.2 Commit Aliases](#32-commit-aliases)
  - [3.3 Branch Aliases](#33-branch-aliases)
  - [3.4 Log Aliases](#34-log-aliases)
- [4. Advanced Aliases](#4-advanced-aliases)
  - [4.1 Custom Scripts](#41-custom-scripts)
  - [4.2 External Commands](#42-external-commands)
