...
- [The three primitives](#the-three-primitives)
  ...
  - [Resources — app-controlled data](#resources--app-controlled-data)
...
- [Building a server from scratch](#building-a-server-from-scratch)
  - [Setup](#setup)
  - [The server](#the-server)
- [The rules for production MCP servers](#the-rules-for-production-mcp-servers)
  - [1. Never write to stdout on stdio servers](#1-never-write-to-stdout-on-stdio-servers)
  - [2. Validate inputs aggressively](#2-validate-inputs-aggressively)
  - [3. Keep tools focused — one tool, one job](#3-keep-tools-focused--one-tool-one-job)
  - [4. Descriptions are your API](#4-descriptions-are-your-api)
  - [5. Return structured, markdown-friendly content](#5-return-structured-markdown-friendly-content)
  - [6. Handle the unhappy path](#6-handle-the-unhappy-path)
  - [7. Mind your secrets](#7-mind-your-secrets)
  - [8. Test with the MCP Inspector](#8-test-with-the-mcp-inspector)
  - [9. Version your server](#9-version-your-server)
  - [10. One server per domain](#10-one-server-per-domain)
- [What about Python?](#what-about-python)
...
## The rules for production MCP servers

### 1. Never write to stdout on stdio servers
...
### 5. Return structured, markdown-friendly content
