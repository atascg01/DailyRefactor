...
- [1. Scoped Values are finally production-ready](#1-scoped-values-are-finally-production-ready)
- [2. Compact Object Headers — smaller objects, less GC pressure](#2-compact-object-headers--smaller-objects-less-gc-pressure)
- [3. Flexible Constructor Bodies — code before super()](#3-flexible-constructor-bodies--code-before-super)
- [4. Module Import Declarations](#4-module-import-declarations)
- [5. What else is in the box?](#5-what-else-is-in-the-box)
- [6. The upgrade path](#6-the-upgrade-path)
